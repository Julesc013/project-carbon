...
- **Compatibility**: Z90 presents as P3 (Z180-compatible) and is intended to execute all Z85 legacy instructions unchanged in legacy tiers (P0–P3). This scaffolding currently implements only a small 8080-compatible subset needed for basic bring-up tests.
...
- **Fast-path gating**: This implementation treats Z90 fast-path instructions as gated features:
  - Allowed only when `CSR_TIER == CARBON_Z80_DERIVED_TIER_P3_Z180` **and** `MODEFLAG_STRICT==0`.
