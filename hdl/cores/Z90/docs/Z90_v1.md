# Z90 v1.0 (Scaffolding) — Turbo Z80 Successor Core
...
- **Turbo gating**: This implementation treats Z90 fast-path instructions as **turbo features**:
  - Allowed only when `CSR_TIER == CARBON_Z80_DERIVED_TIER_P7_TURBO_UNLIMITED` **and** `MODEFLAG_STRICT==0`.
