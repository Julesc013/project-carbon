...
Compose a CP/M 2.2 SYS16 memory image from user-supplied binaries.
This does not ship CP/M binaries; it places provided images into RAM
and emits a flat 64 KiB memory file for --load.
"""
...
def main(argv: List[str]) -> int:
    parser = argparse.ArgumentParser(description="Build a CP/M 2.2 memory image.")
...
if __name__ == "__main__":
    try:
        ...
        print(f"mk_cpm22_image: ERROR: {exc}", file=sys.stderr)
        raise SystemExit(2)
