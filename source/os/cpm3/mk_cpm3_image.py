...
Compose a CP/M 3+ SYS16 memory image from user-supplied binaries.
Banked memory is a TODO; this script builds a flat 64 KiB image.
"""
...
def main(argv: List[str]) -> int:
    parser = argparse.ArgumentParser(description="Build a CP/M 3+ memory image (flat v1).")
...
if __name__ == "__main__":
    try:
        ...
        print(f"mk_cpm3_image: ERROR: {exc}", file=sys.stderr)
        raise SystemExit(2)
