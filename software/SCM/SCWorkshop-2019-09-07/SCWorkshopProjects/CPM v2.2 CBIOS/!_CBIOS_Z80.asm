...
;
; SCC  2018-04-13 : v1.1.0  Modified for SCW (as described above)
; JL   2018-04-28 : v1.2.0  Added option for 64MB compact flash.
; SCC  2019-03-08 : v1.2.1  Added support for Z80sc
...
; <SCC> Z80 SIO port address used in Grant's original version
...
; <SCC> Z80 SIO port address used by LiNC80
#IFDEF      LiNC80
SIOA_D      .EQU $00
SIOA_C      .EQU $02
SIOB_D      .EQU $01
...
; <SCC> Z80 SIO port address used by RC2014 official module
#IFDEF      RC2014
SIOA_D      .EQU $81
SIOA_C      .EQU $80
SIOB_D      .EQU $83
...
; <SCC> Z80 SIO port address used by Z80sc
#IFDEF      Z80sc
SIOA_D      .EQU $80
SIOA_C      .EQU $82
SIOB_D      .EQU $81
...
; <SCC> Z80 SIO port address used by Z50Bus
#IFDEF      Z50Bus
SIOA_D      .EQU $80
SIOA_C      .EQU $82
SIOB_D      .EQU $81
...
;           Initialise SIO
;                                 Assumes that the CTC is correctly set up ...
            LD A,$00
            OUT (SIOA_C),A
            LD A,$18
            OUT (SIOA_C),A
...
#ENDIF
#IFDEF      LiNC80
            .TEXT "LiNC80 CP/M BIOS 1.2 by G. Searle 2007-18"
#ENDIF
#IFDEF      RC2014
            .TEXT "RC2014 CP/M BIOS 1.2 by G. Searle 2007-18"
#ENDIF
#IFDEF      Z80sc
            .TEXT "Z80sc  CP/M BIOS 1.2 by G. Searle 2007-19"
#ENDIF
#IFDEF      Z50Bus
            .TEXT "Z50Bus CP/M BIOS 1.2 by G. Searle 2007-19"
#ENDIF
            .DB CR,LF
            .DB CR,LF
            .TEXT "CP/M 2.2 "
